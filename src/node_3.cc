...
int main (int argc, char *argv[])
{
    ...
    //---------------------------------- SEND 3-4 ----------------------------------
     //SendMessage send_msg_1(NODE_3_IP, NODE_3_MAC, NODE_2_IP, NODE_2_MAC);
     //MessageTransfer msg_tran_1(send_msg_1);

    //-------------------------------- RECEIVE 4-3 ---------------------------------
    // ReceiveMessage rec_msg_1(NODE_2_IP, NODE_2_MAC, NODE_3_IP, NODE_3_MAC);
    // MessageTransfer msg_tran_1(rec_msg_1);

    //---------------------------------- SEND 3-1 ----------------------------------
     //SendMessage send_msg_1(NODE_3_IP, NODE_3_MAC, NODE_1_IP, NODE_1_MAC);
     //MessageTransfer msg_tran_1(send_msg_1);

    //-------------------------------- RECEIVE 1-3 ---------------------------------
    // ReceiveMessage rec_msg_1(NODE_1_IP, NODE_1_MAC, NODE_3_IP, NODE_3_MAC);
    // MessageTransfer msg_tran_1(rec_msg_1);
